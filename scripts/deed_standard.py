...
RULES = [
    ...
    (178, EYE, "מקורות בזהירות — לא נסמכים עליהם לבדם"),
    (179, EYE, "מבחן הכסף וההיקף — כמה כסף נעשה, מי קיבל, מה ההיקף"),
    (180, EYE, "עקרון התצוגה — הסיפור למעלה, המעבדה למטה"),
    (181, EYE, "מבחן הקורא התם — רפרנט, קשר, השתמעות"),
    # פרק א — מקורות
    ...
    (166, PROC, "עשרה דפים קנוניים; לכל מעש canonical_type אחד, והכותב מקבל את הקנוני שלו"),
    (167, EYE, "ויקיפדיה כהשראת כתיבה — לעולם לא כמקור עובדות"),
    (170, PROC, "מעבר עורך סגנון אחרי הכותב: נער משועמם ואז עורך קשוח, הערות בלבד"),
    (171, EYE, "אין טעם AI — אחד־עשר איסורי ניסוח סגורים בתדריך הכותב"),
    # פרק ט — עיצוב ואתר
    (168, UI, "הדף הוא מאמר עם כותרות שהכותב בחר, לא טופס עם תוויות קבועות"),
    (169, UI, "אינפובוקס בדף ממוקד־אדם; שדה בלי ציטוט ביומן אינו מוצג"),
    ...
    # פרק יג — דוקטרינת המנוע
    (172, EYE, "היומן ממצה, הדף בורר — השמטה היא הכרעת כתיבה שנרשמת"),
    (173, EYE, "משפט המנוע — כל פסקה משרתת אותו, והוא ניתן להפרכה מול היומן"),
    (174, PROC, "בודק המנוע — פסק לכל פסקה, לפני עורך הסגנון"),
    (175, PROC, "תומר מאשר את עשרת הדפים הקנוניים בלבד"),
]
